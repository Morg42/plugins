...
commandset = {
    'V200KO1B': {
        ...
        'Vorlauftemperatur_Erhoehung_Zeit_A1M1': {
            'addr': '27fa',
            'len': 1,
            'unit': 'ISNON',
            'set': True,
        ...
        'Raumtemperatur_Soll_Normalbetrieb_M2': {
            'addr': '3306',
            'len': 1,
            'unit': 'ISNON',
            'set': True,
        ...
        'Raumtemperatur_Soll_Party_Betrieb_M2': {
            'addr': '3308',
            'len': 1,
            'unit': 'ISNON',
            'set': True,
        ...
        'Externe_Raumsolltemperatur_Normal_M2': {
            'addr': '3321',
            'len': 1,
            'unit': 'ISNON',
            'set': True,
        ...
        'Externe_Betriebsartenumschaltung_M2': {
            'addr': '3549',
            'len': 1,
            'unit': 'IUINT',
            'set': True,
        ...
        'Partybetrieb_Zeitbegrenzung_M2': {
            'addr': '37f2',
            'len': 1,
            'unit': 'IUINT',
            'set': True,
        ...
        'Temperaturgrenze_red_Betrieb_M2': {
            'addr': '37f8',
            'len': 1,
            'unit': 'ISNON',
            'set': True,
        ...
        'Temperaturgrenze_red_Raumtemp_M2': {
            'addr': '37f9',
            'len': 1,
            'unit': 'ISNON',
            'set': True,
        ...
        'Vorlauftemperatur_Erhoehung_Soll_M2': {
            'addr': '37fa',
            'len': 1,
            'unit': 'ISNON',
            'set': True,
        ...
        'Vorlauftemperatur_Erhoehung_Zeit_M2': {
            'addr': '37fb',
            'len': 1,
            'unit': 'ISNON',
            'set': True,
    ...
    'V200HO1C': {
        ...
        'Warmwasser_Austrittstemperatur': {
            'addr': '0814',
            'len': 2,
            'unit': 'IU10',
            'set': False,
...
unitset = {
    'P300': {
        ...
        'IU2': {
            'unit_de': 'INT unsigned 2',
            'type': 'integer',
            'signed': False,
            'read_value_transform': '2',
        },  # vito unit: UT1U, PR1
        'IU10': {
            'unit_de': 'INT unsigned 10',
            'type': 'integer',
            'signed': False,
            'read_value_transform': '10',
        },  # vito unit:
        'IU100': {
            'unit_de': 'INT unsigned 100',
            'type': 'integer',
            'signed': False,
            'read_value_transform': '100',
        },  # vito unit:
        'IU3600': {
            'unit_de': 'INT unsigned 3600',
            'type': 'integer',
            'signed': False,
            'read_value_transform': '3600',
        },  # vito unit: CS
        'IUBOOL': {
            'unit_de': 'INT unsigned bool',
            'type': 'integer',
            'signed': False,
            'read_value_transform': 'bool',
        },  # vito unit:
        'IUINT': {
            'unit_de': 'INT unsigned int',
            'type': 'integer',
            'signed': False,
            'read_value_transform': '1',
        },  # vito unit:
        'IUNON': {
            'unit_de': 'INT unsigned non',
            'type': 'integer',
            'signed': False,
            'read_value_transform': 'non',
        },  # vito unit: UTI, CO
        'IS2': {
            'unit_de': 'INT signed 2',
            'type': 'integer',
            'signed': True,
            'read_value_transform': '2',
        },  # vito unit: UT1, PR
        'IS10': {
            'unit_de': 'INT signed 10',
            'type': 'integer',
            'signed': True,
            'read_value_transform': '10',
        },  # vito unit: UT, UN
        'IS100': {
            'unit_de': 'INT signed 100',
            'type': 'integer',
            'signed': True,
            'read_value_transform': '100',
        },  # vito unit:
        'IS1000': {
            'unit_de': 'INT signed 1000',
            'type': 'integer',
            'signed': True,
            'read_value_transform': '1000',
        },  # vito unit:
        'ISNON': {
            'unit_de': 'INT signed non',
            'type': 'integer',
            'signed': True,
            'read_value_transform': 'non',
        },  # vito unit:
        'RT': {
            'unit_de': 'ReturnStatus',
            'type': 'list',
            'signed': False,
            'read_value_transform': 'non',
        },  # vito unit: ST, RT
    ...
    'KW': {
        ...
        'IUPR': {
            'unit_de': 'INT unsigned 2.55',
            'type': 'integer',
            'signed': False,
            'read_value_transform': '2.55',
        },  # vito unit: PP
        'IUBOOL': {
            'unit_de': 'INT unsigned bool',
            'type': 'integer',
...
systemschemes = {
    ...
    'V200KO1B': {'01': 'A1', '02': 'A1 + WW', '04': 'M2', '03': 'M2 + WW', '05': 'A1 + M2', '06': 'A1 + M2 + WW'},
    'V200WO1C': {'01': 'WW', '02': 'HK + WW', '04': 'HK + WW', '05': 'HK + WW'},
...
returnstatus = {
    ...
    'KW': {'00': '0', '01': '1', '03': '2', 'AA': 'NOT OK'},
}

setreturnstatus = {'P300': {'00': 'OK', '05': 'SYNC (NOT OK)'}, 'KW': {'00': 'OK', '05': 'SYNC (NOT OK)'}}
